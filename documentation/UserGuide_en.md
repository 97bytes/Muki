...
**PASO 1)** Add to the application, the libraries of a framework that implements the specification [JAX-RS](http://jax-rs-spec.java.net), like [RESTEasy](http://www.jboss.org/resteasy) or other.

**PASO 2)** Add to the application, the Java classes generated by Muki
