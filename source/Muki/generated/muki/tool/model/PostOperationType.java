...
/**
 * <p>Java class for post-operationType complex type.
 * 
 ...
 *         &lt;element name="form-param" type="{http://muki/service-description/}form-paramType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *       &lt;attribute name="param-type" type="{http://www.w3.org/2001/XMLSchema}string" />
...
@XmlType(name = "post-operationType", propOrder = {
    "pathParam",
    "queryParam",
    "formParam",
    "contextParam"
})
public class PostOperationType {
    ...
    protected List<FormParamType> formParam;
    ...
    /**
     * Gets the value of the formParam property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the formParam property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFormParam().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FormParamType> getFormParam() {
        if (formParam == null) {
            formParam = new ArrayList<FormParamType>();
        }
